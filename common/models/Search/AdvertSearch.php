...
class AdvertSearch extends Advert
{
    ...
    {
        return [
            [['idadvert', 'price', 'fk_agent_detail', 'bedroom', 'livingroom', 'parking', 'kitchen', 'hot', 'sold', 'recommend', 'created_at', 'updated_at'], 'integer'],
            [['adress', 'general_image', 'description', 'location', 'type'], 'safe'],
        ];
    }
